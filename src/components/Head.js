...
export default function Head() {
  return (
    <Helmet>
        <title>Retro Star Wars</title>
        <meta name="title" content="Retro Star Wars"/>
        <meta name="description" content="A personal collection of vintage Star Wars toys made by Kenner from 1978 - 1986. Website design by www.ryanwilsondesign.com
        Action figures, vehicles, playsets and more. "/>
        <meta name="keywords" content="star wars toys, retro star wars, vintage star wars, vintage star wars toys, web design Tucson, logo design Tucson, star wars figures, toys, vintage toys, star wars action figures"></meta>
        ...
        Action figures, vehicles, playsets and more. "/>
        <meta property="twitter:image" content="/src/images/websiteimage.png"/>
